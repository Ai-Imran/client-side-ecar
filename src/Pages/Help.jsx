    ...
    return (
        <div className="text-gray-300 min-h-screen">
            <div className="mx-auto lg:ml-[300px] mt-10 text-[18px] md:text-[20px]">
                ...
                আপনি যদি ইতিমধ্যে একাউন্ট খুলে থাকেন এবং সার্ভিসটি নিতে আগ্রহী কিন্তু  আমাদের সাথে যোগাযোগের প্রয়োজন মন করেন তাহলে এখানে ক্লিক করে <Link to={'/contact'}><span className="text-lime-500 underline italic px-1"> যোগাযোগ </span> </Link> করুন সরাসরি আমাদের সাথে।
